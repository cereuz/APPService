...
import com.onezao.appservice.dao.TokenDao;
import com.onezao.appservice.dao.UserDao;
import com.onezao.appservice.util.MD5;
...
public class UserService {
    ...
    public RestFulBean<UserBean> login(String phone, String password)
    {
        ...
        {
            return RestFulUtil.getInstance().getResuFulBean(null, 1, "用户不存在，或密码错误");
        }
    }
